...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu" data-role="dropdown" >' +
                '<div class="calendar left" data-role="calendar" ></div>' +
                '<div class="calendar right" data-role="calendar" ></div>' +
                '<div class="ranges">' +
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            //FIXME
            $('.calendar').on('calendar.day',$.proxy(this.onClickHighlight, this));
           

        },
        
        onClickHighlight : function(e, data)	{
        	
        	
        	if( $(e.target).hasClass("left") || $(e.target).parent().hasClass("left") )	{
        		var start = moment(data.d);
        		this.oldStartDate = this.startDate.clone();
        		 this.startDate = start;
        		 
        		this.container.find('input[name=daterangepicker_start]').val(this.startDate.format(this.format));
        	}
        	else if( $(e.target).hasClass("right") || $(e.target).parent().hasClass("right") )	{
        		var end = moment(data.d);
        		this.oldEndDate = this.endDate.clone();
        		  this.endDate = end;
        	...
        	$( ".ranges li" ).each(function() { $( this ).removeClass( "active" );});
        	
        	this.chosenLabel = this.locale.customRangeLabel;
        	this.container.find('.ranges li:eq(6)').addClass('active');
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            var html = '<div class="calendar-date" data-role="calendar">';
