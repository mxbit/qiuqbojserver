...
(function( $ ) {
    $.widget("metro.calendar", {
        ...
        options: {
            ...
            date: new Date(),
            buttons: true,
            optionButtons : {'reset':true, 'today':false},
        ...
        _renderMonth: function(){
            ...
            if (this.options.buttons) {
            	tdayBtn = this.options.optionButtons.today ? ("<button class='button calendar-btn-today small primary'>"+$.Metro.Locale[this.options.locale].buttons[0]+"</button>") : "";
            	resetBtn = this.options.optionButtons.reset ? ("&nbsp;<button class='button calendar-btn-clear small primary'>"+$.Metro.Locale[this.options.locale].buttons[1]+"</button>") : "";
                tr = $("<tr/>").addClass("calendar-actions");
                td = $("<td/>").attr('colspan', 7).addClass("text-left").html(""+ tdayBtn + resetBtn);
                td.appendTo(tr);
                tr.appendTo(table);
            }
        ...
        ondayClick: function(e,formated)	{
        	//console.log(formated)
        	 sday = new Date(e);
             trdata = {d:sday,f:e};
             
        	this.element.trigger('calendar.day', trdata);
        	},
