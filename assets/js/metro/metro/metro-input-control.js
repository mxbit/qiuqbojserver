(function( $ ) {
    $.widget("metro.inputControl", {
        ...
        initFileInput: function(el, that){
            ...
            wrapper = $("<input type='text' id='__input_file_wrapper__' class='image-input' readonly style='z-index: 1; cursor: default;'>");
            ...
            input.on('change', function(){
                var val = $(this).val();
                if (val != '') {
                    wrapper.val(val.replace(/C:\\fakepath\\/i, '') );
                }
            });
